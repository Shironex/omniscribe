 ...
 * Claude Usage Panel
 *
 * Provides the full Claude usage experience as a Popover:
 * - Trigger: Activity icon with progress bar showing session usage
 * - Content: Session usage (5h window), Sonnet weekly, overall weekly
