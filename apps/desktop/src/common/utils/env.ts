/**
 * Environment variable utilities for spawned processes.
 * Provides allowlist/blocklist filtering to prevent leaking secrets
 * or Electron-internal variables to child processes.
 */
