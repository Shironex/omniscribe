...
export function QuickActionsSection() {
  ...
  const handleModeChange = (mode: QuickActionMode) => {
    updatePreference('session', { ...sessionSettings, quickActionMode: mode });
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsCard
        ...
        tone="gold"
        title="Quick Actions"
        subtitle="Configure how quick actions are executed in terminals."
      >
        <SettingsRow stacked>
          <SettingsRowLabel
            title="Execution mode"
            description="Applies to all quick actions globally."
          />
