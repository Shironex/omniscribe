...
const RepoBadge = ({ className, children }: { className?: string; children: React.ReactNode }) => (
  <span
    className={twMerge(
      ...
      <div className="no-drag flex items-center gap-1.5 px-2 shrink-0">
        ...
        {repoInfo && (
          <div className="flex items-center gap-1.5 px-2 py-1">
            ...
            {repoInfo.isFork && (
              <RepoBadge className="bg-muted-foreground/15 text-muted-foreground">Fork</RepoBadge>
            )}
            {repoInfo.isArchived && (
              <RepoBadge className="bg-orange-500/15 text-orange-500">Archived</RepoBadge>
            )}
          </div>
        )}
