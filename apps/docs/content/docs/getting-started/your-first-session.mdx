...
description: Walk through launching and interacting with your first AI coding session.
---
...
<Callout type="warn">
  Killing a session terminates the underlying process immediately. The AI assistant will not get a
  chance to finish or clean up.
</Callout>
