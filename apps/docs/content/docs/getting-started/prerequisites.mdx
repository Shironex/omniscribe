...
<Callout title="Auto-detection">
  Omniscribe automatically detects which CLIs are installed and adjusts the available AI modes
  accordingly. You only see modes for tools that are present on your system.
</Callout>
