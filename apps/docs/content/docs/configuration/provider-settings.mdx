...
<Callout type="warn">
  Use skip-permissions with caution. This gives the AI assistant full access to your system without
  confirmation prompts. It will be able to read, write, and execute files without asking for your
  approval. Only enable this if you trust the AI's actions and understand the risks.
</Callout>
