---
title: Settings
description: Overview of all settings sections in Omniscribe.
---
...
| Section           | Description                                                                                                                                                         |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sessions**      | Configure the default AI mode for new sessions and toggle the skip-permissions flag.                                                                                |
