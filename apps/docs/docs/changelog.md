...
All notable changes to Omniscribe are documented here. For the latest releases, visit the [GitHub Releases page](https://github.com/Shironex/omniscribe/releases).
...
- **Launch presets modal** — Batch session creation with grid preset cards (2x1, 2x2, 3x2) for quick multi-session setup; opens via Shift+N shortcut
...
## v0.3.0 (2026-02-07) — _Upgrade to 0.3.1_
